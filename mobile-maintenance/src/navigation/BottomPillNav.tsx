...
// Scaffold state — only Dashboard exists. Add a tab here per module as its
// screens land (Attendance, Electricity, etc. — see MainStack.tsx), same
// pattern as mobile-Fixed-Asset's own BottomPillNav TABS array.
const TABS: {
          ...
          return (
            <Pressable
              ...
              style={{
                ...
                borderRadius: 999,
                backgroundColor: active ? "rgba(101,163,13,0.14)" : "transparent",
                borderWidth: 1,
                borderColor: active ? "rgba(101,163,13,0.35)" : "transparent",
              }}
            >
