...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    await pool.request()
      ...
      .input("TotalCheques",     sql.BigInt,    TotalCheques || null)
      ...
      .query(`
        INSERT INTO dbo.ChequeMaster (
          ...
          ChequeStartNumber, ChequeEndNumber, TotalCheques, Remarks,
    ...
    await pool.request()
      ...
      .query(`
        UPDATE dbo.ChequeMaster SET
          ...
          TotalCheques=@TotalCheques, Remarks=@Remarks, Status=@Status,
