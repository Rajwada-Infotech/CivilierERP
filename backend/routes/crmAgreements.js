...
const { validateAgreementPreparationPrerequisites, maybeAutoCreateSalesDeed, maybeResolveAgreementDate, finalizeAgreementDate, syncLegalMilestoneStep } = require("../services/crmWorkflowGuards");
