// Shared read-only list scaffold for the Maintenance module screens
// (Customer Directory, Bills, Personnel, Meters, etc.). Same loading /
// error / pull-to-refresh / empty-state behaviour every list screen
// needs, factored out so each screen stays short and consistent.
            ...
            return (
              <Pressable
                ...
                style={{
                  ...
                  paddingVertical: 7,
                  borderRadius: 999,
                  backgroundColor: active ? "rgba(101,163,13,0.14)" : colors.card,
                  borderWidth: 1,
                  borderColor: active ? "rgba(101,163,13,0.35)" : colors.border,
                }}
              >
                <Text style={{ fontSize: 12, fontFamily: fonts.body.medium, color: active ? "#bef264" : colors.mutedForeground }}>
                  {f}
                </Text>
              </Pressable>
            );
