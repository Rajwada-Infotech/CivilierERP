...
const SEED_ROWS = [
  ...
  {
    EProjectName: "Green Valley Phase 2",
    EDocumentType: "Invoice",
    EDocDate: "2024-01-15",
    EAmount: 120500.0,
    EDocNo: "INV-1002",
  ...
  {
    EProjectName: "Riverside Residency",
    EDocumentType: "Invoice",
    EDocDate: "2024-02-10",
    EAmount: 67250.0,
    EDocNo: "INV-1004",
  ...
  {
    EProjectName: "Metro Commercial Hub",
    EDocumentType: "Invoice",
    EDocDate: "2024-03-05",
    EAmount: 55000.0,
    EDocNo: "INV-1006",
...
async function seed() {
  ...
  try {
    ...
    const existing = await pool
      .request()
      .query("SELECT COUNT(*) AS cnt FROM dbo.ExpenseBooking");
    ...
    for (const row of SEED_ROWS) {
      ...
      console.log(
        `  ✓ Inserted ${row.EDocNo} — ${row.EProjectName}  →  Eid = ${newId}`,
      );
    }
