-- Migration 153: Add Direct Purchase Order (DPO) document type
...
IF NOT EXISTS (SELECT 1 FROM dbo.TypeOfDoc WHERE DocNoPrefix = 'DPO')
  ...
  VALUES ('DPO', 'DPO', 'Direct Purchase Order', 1, 5, 1, ISNULL(@EId_PO, @EId_ANY), 'Purchase Order', 'migration', GETDATE());
