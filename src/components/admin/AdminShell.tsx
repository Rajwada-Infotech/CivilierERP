...
/**
 * Shared glass-themed wrapper for all Admin module pages — mirrors
 * MaterialShell/FinanceShell/CivilWorkDprShell so Admin gets the same
 * ambient glow, frosted header band, and consistent layout as every other
 * module, just tinted to the admin blue accent (#3b82f6).
 */
export const AdminShell: React.FC<AdminShellProps> = ({
  ...
  const glassCard = isDark
    ...
    : {
        ...
        boxShadow:
          "0 8px 32px rgba(59,130,246,0.08), inset 0 1px 0 rgba(255,255,255,0.9)",
      };
    ...
    <div className="relative min-h-full p-4 space-y-5">
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(59,130,246,0.10) 0%, transparent 60%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent 10%, #3b82f6 30%, #3b82f6 70%, transparent 90%)",
          }}
        />
        ...
        <div className="relative z-10 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
          <div className="flex items-center gap-3">
            ...
            >
              {PageIcon ? (
                <PageIcon size={16} style={{ color: "#60a5fa" }} />
              ) : (
...
/** Glass-styled stat card for Admin pages */
export const AdminGlassCard: React.FC<{
  label: string;
