...
/**
 * Shared glass-themed wrapper for Super Admin pages — mirrors
 * AdminShell/DbaShell/MaterialShell/FinanceShell/EngineeringShell, tinted to
 * the super_admin accent (#eab308, matching AppSidebar's MODULE_HEADER for
 * "super_admin").
 */
export const SuperAdminShell: React.FC<SuperAdminShellProps> = ({
  ...
  const glassCard = isDark
    ...
    : {
        ...
        boxShadow:
          "0 8px 32px rgba(234,179,8,0.08), inset 0 1px 0 rgba(255,255,255,0.9)",
      };
    ...
    <div className="relative min-h-full p-4 space-y-5">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden z-0">
        ...
        <div
          ...
          style={{
            background: isDark
              ? "radial-gradient(ellipse, rgba(234,179,8,0.04) 0%, transparent 70%)"
              : "radial-gradient(ellipse, rgba(234,179,8,0.03) 0%, transparent 70%)",
          }}
        />
      </div>
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(234,179,8,0.10) 0%, transparent 60%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent 10%, #eab308 30%, #eab308 70%, transparent 90%)",
          }}
        />
        ...
        <div className="relative z-10 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
          <div className="flex items-center gap-3">
            ...
            >
              {PageIcon ? (
                <PageIcon size={16} style={{ color: "#facc15" }} />
              ) : (
            ...
            <div>
              <h1
                ...
                style={{ color: isDark ? "#fef9c3" : "#713f12" }}
              >
                {title}
              </h1>
              {subtitle && (
