...
import { useReminders, type ReminderItem, formatRelative } from "@/hooks/useReminders";
...
interface ReminderBellProps {
  /** If provided, the parent controls open/close state (controlled mode).
...
export const ReminderBell: React.FC<ReminderBellProps> = ({
  ...
  useEffect(() => {
    if (open && !fetched) refresh();
  }, [open, fetched, refresh]);
