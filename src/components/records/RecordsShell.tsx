...
const ACCENT = "#f59e0b"; // amber — distinct from every other module's color

/**
 * Shared glass-themed wrapper for the standalone Records module.
 * Same visual language as FinanceShell (ambient glow, frosted header band)
 * but in amber rather than indigo, so Records reads as its own module
 * rather than a leftover Finance page.
 */
      ...
      >
        ...
        <div className="relative z-10 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
          <div className="flex items-center gap-3">
            ...
            >
              {PageIcon ? (
                <PageIcon size={16} style={{ color: "#fbbf24" }} />
              ) : (
                <Archive size={16} style={{ color: "#fbbf24" }} />
              )}
            </div>
            <div>
              <h1
