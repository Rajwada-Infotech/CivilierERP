          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-xs font-heading text-muted-foreground group-hover:text-foreground transition-colors text-center leading-tight">
                  Finance
                </span>
                {activeModule === "finance" && (
              ...
              <div className="mt-1.5">
                ...
                {currentUser?.role === "user" && (
                  <span className="text-[10px] px-2 py-0.5 rounded-full font-heading bg-muted text-muted-foreground">
                    User · {currentUser.pagePermissions.length} permissions
                  </span>
                )}
              </div>
            </div>
