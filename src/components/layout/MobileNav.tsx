          ...
          <div className="absolute bottom-0 left-0 right-0 rounded-t-2xl bg-card border-t border-border animate-slide-up max-h-[85vh] overflow-y-auto">
            ...
            <div className="p-3 space-y-0.5">
                    ...
                    <div className="grid grid-cols-5 gap-1.5 px-1">
                      {masterItems.map(({ icon: Icon, label, path, color }) => (
                        ...
                        >
                          ...
                          <span className="text-[9px] font-heading text-muted-foreground text-center leading-tight">
                            {label}
                          </span>
                        </button>
                      ))}
              ...
              <div className="border-t border-border pt-2 mt-1">
                ...
                <div
                  className={`overflow-hidden transition-all duration-200 ${themeOpen ? "max-h-64 opacity-100" : "max-h-0 opacity-0"}`}
                >
