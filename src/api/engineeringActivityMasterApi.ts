...
// Engineering's own Activity Master — split from the shared activityMasterApi.ts
// (migration 463); Civil Work DPR keeps using that original one. Same shape,
// fully separate data from this point on.
const BASE = "/api/engineering-activity-master";
...
export const toPayload = (
  ...
  return {
    ...
    // Custom-render select (see EngineeringActivityMaster.tsx) hands back
    // the raw id as a string via onChange — parse it, don't cast, or "" is
    // coerced to 0.
