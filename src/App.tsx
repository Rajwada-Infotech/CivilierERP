...
const FinancialYearMaster = lazy(() => withDelay(() => import("./pages/masters/FinancialYearMaster")));
const ChequeMaster = lazy(() => withDelay(() => import("./pages/masters/ChequeMaster")));
const MaterialExpenseBookingMaster = lazy(() => withDelay(() => import("./pages/material/MaterialExpenseBooking")));
const WorkOrderMaster = lazy(() => withDelay(() => import("./pages/material/WorkOrderMaster")));
const PurchaseOrderMaster = lazy(() => withDelay(() => import("./pages/material/PurchaseOrderMaster")));
const CardMaster = lazy(() => withDelay(() => import("./pages/masters/CardMaster")));
const TdsMaster = lazy(() => withDelay(() => import("./pages/masters/TdsMaster")));
const AccountGroupMaster = lazy(() => withDelay(() => import("./pages/masters/AccountGroupMaster")));
const NamedEntryTypeMaster = lazy(() => withDelay(() => import("./pages/masters/NamedEntryTypeMaster")));
