              ...
              <div className="flex flex-col justify-end">
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${form.status ? "bg-emerald-500" : "bg-muted border border-border"}`}
                  >
                    <span
                      className={`inline-block h-4 w-4 rounded-full bg-white transition-transform shadow-sm ${form.status ? "translate-x-6" : "translate-x-1"}`}
                    />
                  </button>
                  <span className={`text-xs font-heading font-semibold uppercase tracking-widest ${form.status ? "text-emerald-500" : "text-muted-foreground"}`}>
