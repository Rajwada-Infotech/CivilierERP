...
const RoomMaster: React.FC = () => {
  ...
  return (
    <>
      ...
      <div>
        <h1 className="text-xl font-heading font-bold text-foreground">Room Master</h1>
        <p className="text-xs text-muted-foreground mt-0.5">Manage rooms within units and their blocks</p>
      </div>
      <MasterPage
        title="Room"
        fields={fields}
