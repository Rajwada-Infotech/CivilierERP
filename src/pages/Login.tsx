...
export default function Login() {
  ...
  return (
    <div
      className="min-h-screen w-full flex items-center justify-center px-4 py-8 overflow-auto"
      style={{
        background:
          "linear-gradient(135deg, #f3e8ff 0%, #e9d5ff 25%, #ffffff 60%, #f8f4ff 100%)",
      }}
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(90deg,#d1d5db 0%,#e5e7eb 40%,#f9fafb 75%,#ffffff 100%)",
      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex flex-col items-center gap-3">
            <img
              ...
              style={{
                filter: "drop-shadow(0 10px 24px rgba(124,58,237,0.4))",
              }}
            />
            <h1
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="block text-xs font-medium uppercase tracking-wide mb-1.5 ml-1 text-slate-700">
              Email Address
            </label>
            <input
              type="email"
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3 top-8 text-slate-500 hover:text-purple-700 transition-colors"
            >
