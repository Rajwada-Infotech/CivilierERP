      ...
      <SalesShell
        ...
        action={
          <button
            onClick={() => refetch()}
            disabled={isFetching}
            className="flex items-center gap-2 px-3 py-1.5 text-xs rounded-lg border border-violet-500/30 hover:bg-violet-500/10 transition-colors disabled:opacity-50"
            style={{ color: "#c084fc" }}
          >
