    ...
    <ScrollView className="flex-1" style={{ backgroundColor: colors.background }} contentContainerStyle={{ padding: 16, paddingBottom: 32 }}>
      ...
      {hasEmi && (
        <View className="mt-4">
          ...
          <View className="flex-row flex-wrap justify-between">
            <View style={{ width: "48%", marginBottom: 8 }} className="rounded-xl items-center py-3" style={{ backgroundColor: "#8b5cf61a", borderWidth: 1, borderColor: "#8b5cf640" }}>
            ...
            <View style={{ width: "48%" }} className="rounded-xl items-center py-3" style={{ backgroundColor: `${colors.muted}50`, borderWidth: 1, borderColor: `${colors.border}80` }}>
